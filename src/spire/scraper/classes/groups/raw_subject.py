...
SUBJECT_OVERRIDES = key_override_factory(
    ...
    ("FORLANGC", ("FORLANGC", "Five College Center: World Languages")),
    ("FINOPMGT", ("FINOPMGT", "Finance and Operations Management")),
    (("HM&FN", "HMFNART", "HM&FNART"), ("HFA", "Humanities & Fine Arts")),
    ("HT-MGT", ("HTM", "Hospitality & Tourism Management")),
    ("HISPAN", ("HISPAN", "Hispanic Literature & Linguistics")),
    ...
    ("SLHS", ("SLHS", "Speech, Language, & Hearing Sciences")),
    ("STPEC", ("STPEC", "Social Thought & Political Economy")),
