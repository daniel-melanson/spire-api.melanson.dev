    ...
    operations = [
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                ...
                                regex="^(?P<subject_id>[A-Z\\-@]{2,9}[A-Z]) (?P<course_number>[\\x00-\\x7F]{1,9}[A-Za-z0-9])$",
                            )
                        ],
                    ),
                ),
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                ...
                                regex="^(?P<course_number>[\\x00-\\x7F]{1,9}[A-Za-z0-9])$",
                            )
                        ],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instructors",
                    models.ManyToManyField(related_name="sections", to="spire.staff"),
                ),
                (
                    "section",
                    models.ForeignKey(
