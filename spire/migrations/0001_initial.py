            ...
            fields=[
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="must be a course ID (match course ID RegExp)", regex="^.+$"
                            )
                        ],
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="must be a course title (match course title RegExp)", regex="^.+$"
                            )
                        ],
                    ),
                ),
            ...
            fields=[
                (
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="must be a  title (match subject title RegExp)", regex="^.+$"
                            )
                        ],
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="must be a  title (match subject id RegExp)", regex="^.+$"
                            )
                        ],
                    ),
                ),
