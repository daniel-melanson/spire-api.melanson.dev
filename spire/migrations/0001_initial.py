...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('individual_availability', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='spire.sectionavailability')),
                ('enrollment_total', models.IntegerField()),
                ('available_seats', models.IntegerField()),
                ('wait_list_capacity', models.IntegerField()),
                ('wait_list_total', models.IntegerField()),
